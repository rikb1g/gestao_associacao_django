...
from .views import (EditEscola, CriarEscola, CreateMensalidade,AtividadesList,AtividadeNew,remover_atividade,
                    AtividadeEdit,MensalidadeList,MensalidadeCreate,MensaliadeEdit,remover_mensalidade, atualizar_mensalidade_aluno)
...
urlpatterns = [
    ...
    path('novaMensalidade/',MensalidadeCreate.as_view(),name='mensalidade_new'),
